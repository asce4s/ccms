...
@section('content')
    <div class="row" ng-controller="drugController" ng-cloak>
        ...
        <div class="col-md-6">
            ...
            <div class="box box-primary">
                ...
                <div class="box-header with-border">
                    <h3 class="box-title">@{{titletxt}} Drug</h3>
                </div>
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" step="0.01" min="0" class="form-control" ng-model="data.price" name="price" required>
                            </div>
    ...
    <script>
        ...
        app.controller('drugController', function ($scope, $http, $controller, DTOptionsBuilder, DTColumnBuilder) {
            ...
            var cols = [
                        DTColumnBuilder.newColumn('itemcode').withTitle('Drug Code'),
