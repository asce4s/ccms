        ...
        <div class="col-md-12">
            <div class="box">
                <div class="box-header">
                    <form action="{{url('lab')}}/view" method="get">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <table class="table table-bordered table-striped">
                                ...
                                <tr ng-repeat="i in testSaleData">
        ...
        app.controller('saleController', function ($scope, $http, $controller, SweetAlert) {
            ...
            $scope.saleView = function (id, total) {
                ...
                $http({
                    ...
                    $scope.saleData = response.data.sale;
                    $scope.testSaleData = response.data.test;
