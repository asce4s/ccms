            ...
            <div class="box box-primary">
                ...
                <form name="frm">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <label>Phone</label>
                            <input type="phone" class="form-control" ng-model="data.phone" name="phone" pattern=".[^_]{13}" required data-inputmask='"mask": "(999) 999-9999"' data-mask>
                        </div>
                    ...
                    <div class="box-footer">
                        ...
                        <button type="submit" class="btn btn-primary" ng-click="delete('doc')" ng-if="show"
                                confirm="This will also delete all the patient records associated. Are you sure ?" confirm-settings="{size: 'sm',ok:'Yes'}">Delete
                        </button>
